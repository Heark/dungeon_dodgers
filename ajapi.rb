...
module GameJolt
  ...
  GameId = "37209"
  PrivateKey = "4639ebeccadaa8d45b43dce83cde9e82"
end
...
module ENET
  @createMD5string = Win32API.new('enet.dll', 'GetChecksumFromString', 'pp', 'I')
...
module GameJolt
  ...
  def self.do_request(baseUrl)
    urlHash = ENET.calc_md5("http://gamejolt.com/api/game/v1/" + baseUrl + "&game_id=" + GameId + "&format=json" + PrivateKey)
    urlHash = urlHash[0]
